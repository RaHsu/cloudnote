		...
		<div id="container">
			...
			<div id="non-intro">
				...
				<div id="content">
					...
					<form action="actionnote.php?action=update" method="post" id="form">
						<div id="edittitle">
							<?php
						connect_mydb();
						select_mydb();
						...
						echo '<input type="text" class="form-control" id="inputtitle" name="title" style="border-radius: 0px;" placeholder="输入笔记标题" value="'.$row['title'].'" />';
						
						mysqli_close($mydb);
						?>
<!--							<input type="text" class="form-control" id="inputtitle" name="title" placeholder="输入笔记标题" />
-->						</div>
						<div id="edit">
							<?php
						connect_mydb();
						...
						echo '<textarea id="editor" name="content" placeholder="输入你的笔记">'.$row['content'].'</textarea>';
